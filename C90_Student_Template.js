...
function add() {
	...
	car1_imgTag = new Image(); //defining a variable with a new image   /*Upload the correct car*/
	car1_imgTag.onload = uploadcar1; // setting a function, onloading this variable  /*Assign a correct car_image variable*/
